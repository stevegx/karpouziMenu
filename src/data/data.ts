      ...
      items: [
        {
          ...
          price: 2.0,
          flavors: {
            el: ["Άλφα", "Μύθος", "Fix", "Ζύθος", "Βεργίνα", "Amstel"],
            en: ["Alfa", "Mythos", "Fix", "Zythos", "Vergina", "Amstel"],
            tr: ["Alfa", "Mythos", "Fix", "Zythos", "Vergina", "Amstel"],
          },
          description: { el: "", en: "", tr: "" },
        ...
        {
          title: { el: "HEINEKEN", en: "HEINEKEN", tr: "HEINEKEN" },
          price: 2.5,
          description: { el: "", en: "", tr: "" },
          photoUrl: "/assets/LAGER & CLASSIC.avif",
          allergens: ["gluten"],
        ...
        },
        {
          ...
          flavors: {
            ...
            en: ["Sedusa", "Nissiopi", "Fix Dark"],
            tr: ["Sedusa", "Nissiopi", "Fix Dark"],
          },
          description: { el: "", en: "", tr: "" },
